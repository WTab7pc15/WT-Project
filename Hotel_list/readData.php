...
{
    $query ="SELECT hotel_id,hotel_name,star_rating,address,public_rating,review_count,price,hotel_image FROM hotel_details WHERE ( hotel_name like '" . $_POST["keyword"] . "%' or  city like '" . $_POST["keyword"] . "%' or state like '" . $_POST["keyword"] . "%' ) and hotel_details.price < 7500 LIMIT 30;";
